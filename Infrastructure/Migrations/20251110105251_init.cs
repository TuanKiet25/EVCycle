    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ListingBatteries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ListingBatteries_Batteries_BatteryId",
                        column: x => x.BatteryId,
                        principalTable: "Batteries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ListingBatteries_Listings_ListingId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ListingVehicles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ListingVehicles_Listings_ListingId",
                        column: x => x.ListingId,
                        principalTable: "Listings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ListingVehicles_Vehicles_VehicleId",
                        column: x => x.VehicleId,
                        principalTable: "Vehicles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ListingBatteries_BatteryId",
                table: "ListingBatteries",
                column: "BatteryId");

            migrationBuilder.CreateIndex(
                name: "IX_ListingBatteries_ListingId",
                table: "ListingBatteries",
                column: "ListingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ListingVehicles_ListingId",
                table: "ListingVehicles",
                column: "ListingId");

            migrationBuilder.CreateIndex(
                name: "IX_ListingVehicles_VehicleId",
                table: "ListingVehicles",
                column: "VehicleId");
        }
